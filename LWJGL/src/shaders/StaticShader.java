...
public class StaticShader extends ShaderProgram{
	...
	private int location_isUnderwater;
	...
	protected void getAllUniformLocations() {
		...
		location_isUnderwater = super.getUniformLocation("isUnderwater");
	...
	public void connectTextureUnits(){
		...
		super.loadInt(location_reflectionTexture, 6);
		super.loadInt(location_refractionTexture, 7);
		super.loadInt(location_EnviroMap, 8);
	}
	...
	public void loadUnderwater(boolean isUnderwater){
		super.loadBoolean(location_isUnderwater, isUnderwater);
	}
