...
public class PostProcessing {
	...
	private static ContrastChange contrastChanger;
	...
	public static void init(Loader loader){
		...
		contrastChanger = new ContrastChange();
		brightFilter = new BrightFilter(Display.getWidth()/2, Display.getHeight()/2);
		combineFilter = new CombineFilter();
		hBlur = new HorizontalBlur(Display.getWidth()/5,Display.getHeight()/8);
		vBlur = new VerticalBlur(Display.getWidth()/5,Display.getHeight()/8);
	}
